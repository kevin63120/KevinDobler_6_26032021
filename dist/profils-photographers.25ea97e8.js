...
},{}],"scriptsJS/profils-photographers.js":[function(require,module,exports) {
"use strict";
...
fetch("/data-profils/data-photographers.json").then(function (Response) {
  ...
  var profils = data.photographers;
  var pictures = data.media;
  profils.forEach(function (profil) {
    new _photographers.Profil(profil).personalPageHeader(sectionHeader);
    console.log(profil);
  });
});
...
},{}]},{},["../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scriptsJS/profils-photographers.js"], null)
//# sourceMappingURL=/profils-photographers.25ea97e8.js.map